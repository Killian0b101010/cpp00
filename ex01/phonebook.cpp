...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/11 15:02:51 by kiteixei          #+#    #+#             */
/*   Updated: 2025/10/31 09:33:52 by kiteixei         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Contact::~Contact(void) { std::cout << "Destructor called" << std::endl; }

static bool isChar(char c) { return std::isalpha(c); }
...
static bool isDigitChar(char c) { return std::isdigit(c); }
...
void Contact::contactSet() {
  ...
  do {
    ...
    if (!isValidPhone(phoneNumber) || phoneNumber.empty() ||
        phoneNumber.length() < 2 || phoneNumber.length() >= 15)
